...
export default function HomeSection() {
  return (
    <section id="home" className="ml-6 lg:pt-0 lg:ml-20">
    <div className="grid grid-cols-1 lg:grid-cols-12">
        <div className="col-span-7 place-self-center">
            ...
            <div>
                ...
                <button type="button" data-te-ripple-init className="px-4 py-2 rounded-xl duration-200 mr-4 text-white bg-violet-700 hover:bg-rose-500">
                    ...
                    {/* github */}
                    <a href="https://github.com/manjeet-2002/" target="_blank">
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        className="h-5 w-5 rounded-full text-slate-400 hover:text-white duration-200"
                        fill="currentColor"
                        viewBox="0 0 24 24">
                        <path
                    ...
                    {/* insta */}
                    <a href="https://www.instagram.com/mn._jit/" target="_blank">
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            className="h-5 w-5 hover:text-rose-400 text-slate-400 duration-200"
                            fill="currentColor"
                            viewBox="0 0 24 24">
                            <path
        ...
        <div className="col-span-5 mx-10 place-self-center">
            <Image
                src="/prog.svg"
